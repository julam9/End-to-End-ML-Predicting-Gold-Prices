...
df_visualization = load_gold_data(start_date="2015-01-01", end_date="2024-12-31")
df_training = load_gold_data(start_date="2022-01-01", end_date="2024-12-31")
